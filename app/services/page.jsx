        ...
        {/* <div className="services-secB">
          <div className="container sec-padd-all text-center">
            <div className="heading">
              ...
              <p>
                To offer the best business benefits to our clients, we adhere to
                a streamlined and systematic process for our mechanical design
                services.
              </p>
            </div>
              ...
              >
                <SwiperSlide>
                  <div className="process-wrap">
                    ...
                    <p>meet with the client to discuss their business challenges and project requirements.</p>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div className="process-wrap">
